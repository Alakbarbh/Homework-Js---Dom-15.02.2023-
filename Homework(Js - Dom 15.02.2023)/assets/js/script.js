...
// let elem = document.querySelector("#products .card-item2 h1");
...
// let element = document.querySelector("#products .cars-item1 h1");
...
// element.className.remove("header")
...
//     if (!this.classList.contains("actice-icon") && !body.classList.contains("active-body")) {
...
btn.addEventListener("click",function(){
    ...
    let itemli = document.querySelectorAll("#products ul li");
